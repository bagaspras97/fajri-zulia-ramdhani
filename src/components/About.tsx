        ...
        <div className="flex flex-col lg:flex-row gap-8 sm:gap-12 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="relative z-10 bg-gradient-to-br from-[#F9F7FB] to-[#F4F0F8] p-4 sm:p-6 rounded-3xl shadow-xl">
                ...
                <div className="mt-6 sm:mt-8 p-3 sm:p-5 bg-white rounded-xl border border-[#B284BE]/20 shadow-md">
                  <div className="text-[#B284BE] text-3xl sm:text-4xl font-serif">"</div>
                  <p className="text-gray-700 italic mb-2 text-sm sm:text-base">Dedicated to advancing Islamic studies through research, education, and community engagement.</p>
                  <div className="text-[#B284BE] text-3xl sm:text-4xl font-serif text-right">„</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-3 mt-8 sm:mt-10">
              <div className="text-center">
                <div className="text-[#B284BE] font-bold text-xl sm:text-2xl">5+</div>
                <div className="text-gray-600 text-xs">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="text-[#B284BE] font-bold text-xl sm:text-2xl">10+</div>
                <div className="text-gray-600 text-xs">Publications</div>
              </div>
              <div className="text-center">
                <div className="text-[#B284BE] font-bold text-xl sm:text-2xl">3+</div>
                <div className="text-gray-600 text-xs">Books</div>
              </div>
              <div className="text-center">
                <div className="text-[#B284BE] font-bold text-xl sm:text-2xl">4+</div>
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6 relative">
              ...
              <div className="relative pl-12 sm:pl-14">
                <div className="absolute left-0 top-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#F4F0F8] border-2 border-[#B284BE] flex items-center justify-center flex-shrink-0">
                  <span className="text-[#B284BE] text-sm sm:text-base">✍️</span>
                </div>
              ...
              <div className="relative pl-12 sm:pl-14">
                <div className="absolute left-0 top-0 w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#F4F0F8] border-2 border-[#B284BE] flex items-center justify-center flex-shrink-0">
                  <span className="text-[#B284BE] text-sm sm:text-base">🎓</span>
                </div>
                <div className="bg-white p-3 sm:p-5 rounded-xl shadow-sm border border-[#B284BE]/10">
                  <h4 className="text-lg sm:text-xl font-semibold text-gray-800 mb-1 sm:mb-2">
                    Lecturer & Educator
            ...
            <div className="mt-6 sm:mt-10">
              <h4 className="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3">Expertise & Focus Areas</h4>
