...
export default function QuoteSection() {
  ...
  const quote =
    "Turning complex ideas into clear, compelling narratives that inspire and educate.";
  ...
  return (
    <section
      ref={quoteRef}
      className="w-full py-16 sm-py-24 px-6 md:px-16 relative overflow-hidden bg-gradient-to-b from-white to-purple-50"
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        <motion.div
          className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg p-8 md:p-16 border border-purple-100"
          style={{
            rotateX,
            rotateY,
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <motion.div className="absolute -top-6 -left-6 w-12 h-12 bg-gradient-to-br from-[#B284BE]/20 to-[#D4BFE0]/20 rounded-lg -z-1" />
            <motion.div className="absolute -bottom-8 -right-8 w-16 h-16 bg-gradient-to-tr from-[#B284BE]/20 to-[#D4BFE0]/20 rounded-lg -z-1" />
